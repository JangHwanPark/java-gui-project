...
public class SuvDTO extends LexusDTO {
    public SuvDTO(int productId, String productName, String productImg, String productState, int year, String model, String color) {
